#!/usr/bin/env python3
"""评论质量日报残留脚本：按母业务/子业务两层汇总，生成 Markdown 日报并通过企微机器人推送。

注意：本文件属于评论质量日报链路，只是历史上保留在当前目录中；它不参与 TAO 看板的 `com.qc-dashboard.daily-push` / `com.qc-dashboard.auto-refresh` 两条本地定时任务。
